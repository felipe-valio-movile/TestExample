...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/felipe.valio@movile.com/TestExample'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'felipe.valio@movile.com' => 'felipe.valio@movile.com' }
  s.source           = { :git => 'https://github.com/felipe.valio@movile.com/TestExample.git', :tag => s.version.to_s }
  ...
  s.test_spec 'Tests' do |test_spec|
    test_spec.source_files = 'TestExample/Tests/**/*'
  end
end
